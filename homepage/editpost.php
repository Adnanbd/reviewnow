    ...
    <div class="container conbac">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <?php
                $foodsql = mysqli_query($con, "SELECT * FROM food where review_id =$tempid");

                if (mysqli_num_rows($foodsql) < 1) {
                    $moviesql = mysqli_query($con, "SELECT * FROM movie where review_id =$tempid");

                    if (mysqli_num_rows($moviesql) < 1) {
                        $booksql = mysqli_query($con, "SELECT * FROM book where review_id =$tempid");
                        ...
                        if (mysqli_num_rows($booksql) < 1) {
                            ...
                            $string =  '<div class="tab-pane" id="tab2">' .
                                ...
                                '                                        </div>' .
                                '                                        <div class="col-md-9">' .
                                '                                            <input class="form-control" type="text" value="' . $res['book_name'] . '"  id="input" name="bookName" placeholder="Name of Book..." required>' .
                                '                                        </div>' .
                                '                                    </div>' .
                                '                                    <div class="row">' .
                                '                                        <div class="col-md-3">' .
                                ...
                                '                                                <option class="form-control" value="' . $res['book_category'] . '" >' . $res['book_category'] . '</option>' .
                                ...
                                '                                        </div>' .
                                '                                        <div class="col-md-6">' .
                                '                                            <input class="form-control" type="text" id="input" value="' . $res2['detail_location'] . '" name="bookDetailLocation" placeholder="Shop Name, Road No, House No etc" required>' .
                                '                                        </div>' .
                                '                                    </div>' .
                                '                                    <div class="row">' .
                                '                                        <div class="col-md-3">' .
                                ...
                                '                                        </div>' .
                                '                                        <div class="col-md-9">' .
                                '                                            <textarea class="form-control" id="textarea" rows="4" name="bookDescription" required>' . $res2['description'] . '</textarea>' .
                                '                                        </div>' .
                                '                                    </div>' .
                                '                                    <div class="row">' .
                                '                                        <div class="col-md-3">' .
                                ...
                                '                                        </div>' .
                                '                                        <div class="col-md-9">' .
                                '                                            <input class="form-control" type="number" id="input" value="' . $res2['price'] . '" name="bookPrice" placeholder="Price of Food item" required>' .
                                '                                        </div>' .
                                '                                    </div>' .
                                '                                    <div class="row">' .
                                '                                        <div class="col-md-3">' .
                        ...
                        $rsql = mysqli_query($con, "SELECT * FROM review where review_id =$tempid");
                        $res2 = mysqli_fetch_array($rsql);
                        $string =  '<div class="tab-pane" id="tab3">' .
                            '                            <form action="" method="post" enctype="multipart/form-data">' .
                            '                                <fieldset class="form-control formStyle">' .
                            '                                    <div class="row">' .
                            '                                        <div class="col-md-3">' .
                            ...
                            '                                        </div>' .
                            '                                        <div class="col-md-9">' .
                            '                                            <input class="form-control" type="text" id="input" value="' . $res['movie_name'] . '" name="movieName" placeholder="Name of a Movie..." required>' .
                            '                                        </div>' .
                            '                                    </div>' .
                            '                                    <div class="row">' .
                            '                                        <div class="col-md-3">' .
                            ...
                            '                                                <option class="form-control"  value="' . $res['movie_category'] . '">' . $res['movie_category'] . '</option>' .
                            ...
                            '                                        </div>' .
                            '                                        <div class="col-md-9">' .
                            '                                            <textarea class="form-control" id="textarea" rows="4" name="movieDescription" required>' . $res2['description'] . '</textarea>' .
                            '                                        </div>' .
                            '                                    </div>' .
                            '                                    <div class="row">' .
                            '                                        <div class="col-md-3">' .
